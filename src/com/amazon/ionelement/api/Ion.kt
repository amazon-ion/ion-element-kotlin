...
@JvmOverloads
fun ionNull(elementType: ElementType = ElementType.NULL): Element = ALL_NULLS.getValue(elementType)
...
private val ALL_NULLS = ElementType.values().map { it to NullIonElement(it) as Element }.toMap()
